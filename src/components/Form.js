...
import { useMultipleReveal } from './hooks/useAnimation';

const Form = () => {
    useMultipleReveal(['.input_one', '.input_two', '.input_three', '.input_four', '.input_five', '.input_six'])
            ...
            {!submitted && !isLoading &&
                <>
                    <form onSubmit={submit}>
                        <InputsContainer>
                            <div className='input__container input_one'>
                                <DynamicInput
                            ...
                            <div className='input__container input_two'>
                                <DynamicInput
                        ...
                        <InputsContainer>
                            <div className='input__container input_three'>
                                <DynamicInput
                            ...
                            <div className='input__container input_four'>
                                <DynamicInput
                        ...
                        <InputsContainer>
                            <div className='input__container full input_five'>
                                <DynamicInput
                        ...
                        <InputsContainer>
                            <div className='input__container full input_six'>
                                <Textarea
